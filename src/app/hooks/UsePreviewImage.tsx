...
export default function UsePreviewImage() {
      ...
      const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>, imageKey: string) => {
        ...
        if (selectedFile) {
          ...
          setPreviews((prevPreviews) => ({
            ...prevPreviews,
            [imageKey]: URL.createObjectURL(selectedFile), // Cria um link temporário para exibir a imagem
          }));
        }
      };
