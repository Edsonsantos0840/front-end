...
export default async function Menu() {
  ...
  return (
    <Popover className="relative focus:border-none">
      ...
      >
        <PopoverPanel className="absolute left-[-90px]  z-10 mt-3 flex w-screen lg:max-w-min ">
          <div className="w-full px-4 pb-2  text-sm font-semibold  text-gray-700 shadow-lg  inset-0 bg-black/10 backdrop-blur-md">
            <p >Olá:  <strong className=' text-lg'>@{  user.data?.name  }</strong></p>
