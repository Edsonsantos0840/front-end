...
export default async function UserwithId({
  ...
  return (
    <div className=" ">
      ...
      <h2 className="text-2xl text-center">Não é possível acessar de dispositivos móveis. </h2>
      ...
      <Link href={'/'} className="px-8 py-2 bg-principal rounded-lg text-textos2 font-bold hover:scale-105" >Voltar</Link>
      </article>
          ...
          <section className=" font-ysabeau bg-fundo2 rounded-2xl  p-5 ">
            ...
            <article className="my-4">
              ...
              <p>
                ...
                Sobre mim: Sempre em busca de novas experiências e aprendizados
                Curioso por tecnologia, inovação e criatividade Apreciador de
                boas conversas e novas conexões. Membro desde:{" "}
                {userCard.createdAt
